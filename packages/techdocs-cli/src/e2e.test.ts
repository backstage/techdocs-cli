...
const executeTechDocsCliCommand = (args: string[], opts: ExecuteCommandOptions = {}): Promise<CommandResponse> => {
  return new Promise((resolve) => {
    ...
    listen.on('exit', (code) => {
      ...
      commandResponse.combinedStdOutErr = Buffer.concat(combinedChunks).toString('utf8');
